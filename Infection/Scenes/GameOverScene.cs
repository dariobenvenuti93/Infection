...
namespace Infection
{
    internal class GameOverScene : Scene
    {
        ...
        public GameOverScene(string textName, KeyCode exit = KeyCode.Return)
        {
            exitKey = exit;
        }
        ...
        public override void Start()
        {
            ...
            bg.SetColor(new Vector4(1.0f, 0.0f, 0.0f, 1.0f));

            text1 = new TextObject(new Vector2(Game.Window.Width * 0.3f, Game.Window.Height * 0.3f), $"The virus has spread!");
            text1.IsActive = true;
